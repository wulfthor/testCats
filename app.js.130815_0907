...
app.get('/awdiff/:value', function (req, res) {
    ...
    myLookup(selector).then(function (data) {
        ...
        Q(smkRoutes.smkSearch(value)).then(function (retval) {
            ...
            var query = {'artwork.corpusId': value};
            var selector = {};
            var updator = {};
            ...
            console.log("U: " + JSON.stringify(updator));
            console.log("Q: " + JSON.stringify(selector));

            var col = db.collection("samples");
            var bulk = col.initializeOrderedBulkOp();
            bulk.find(selector).update({$set: updator});
